...
export default function BranchManagerQueuePage() {
  ...
  const fetchQueue = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/v1/leave-approval/queue/branch?${params}`,
        { credentials: "include" }
      );
      ...
      if (response.ok) {
        ...
        console.error("Failed to fetch approval queue");
      }
    } catch (error) {
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/v1/leave-approval/applications/${selectedApp.id}/approve-branch`,
        {
          method: "POST",
          credentials: "include",
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-600">
          Review and approve leave requests from your branch employees
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            >
              ...
              <option value="APPROVED_BRANCH">Approved (Pending HO)</option>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow p-12 text-center">
          <p className="text-gray-500">No leave applications pending approval</p>
        </div>
      ) : (
